  ...
  return (
    <>
      <div className="bg-white_A700 flex font-inter items-center justify-start mx-[auto] p-[9px] w-[100%]">
        <div className="flex flex-col items-center justify-start max-w-[1111px] mb-[70px] mx-[auto] md:px-[20px] w-[100%]">
          <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-start w-[100%]">
            ...
            <Img
              ...
              className="h-[33px] md:ml-[0] ml-[349px] md:mt-[0] mt-[4px] w-[auto]"
              alt="arrowup"
            />
            <Text
              className="bg-white_A700 flex h-[40px] items-center justify-center mb-[9px] md:ml-[0] ml-[7px] not-italic outline outline-[1px] outline-black_900 rounded-[50%] text-black_900 text-center w-[40px]"
              variant="body2"
            >
              Logout
            </Text>
          ...
          <div className="flex md:flex-col flex-row gap-[35px] items-start justify-start md:w-[100%] w-[92%]">
            <div className="flex flex-col justify-start md:mt-[0] mt-[40px] md:w-[100%] w-[96%]">
              ...
              <div className="flex md:flex-col flex-row md:gap-[20px] items-start justify-start md:ml-[0] ml-[6px] mt-[45px] md:w-[100%] w-[95%]">
                ...
                <Button className="bg-transparent cursor-pointer font-normal leading-[normal] min-w-[126px] md:ml-[0] ml-[30px] md:mt-[0] mt-[2px] not-italic sm:text-[20px] md:text-[22px] text-[24px] text-black_900 text-center w-[auto]">
                  Add Target
                </Button>
                <Button className="bg-red_A700 cursor-pointer font-normal leading-[normal] min-w-[195px] md:ml-[0] ml-[524px] not-italic py-[3px] rounded-[16px] text-[20px] text-center text-white_A700 w-[auto]">
                  Finish and Save
                </Button>
              </div>
            </div>
